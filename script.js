...
let tasks = [
  [
    "Treino de Costas/Cardio 🏋️‍♀️",
    "Leitura Diária 📖",
    "Comprar Ração pro Cachorro 🐶",
  ],
  ["Trabalho da Faculdade 🏫", "Lavar Louças 🏡", "Estender Roupas 👘"],
  [
    "Landing Page de Cliente 👨‍💻",
    "Suporte das API's",
    "Daily Scrum ⏱",
    "Slides para Prova 🧾",
  ],
  ["Resumo da Faculdade 📚", "Contas de Água e Luz 🧾", "Pix p/ Mamãe 👩‍👦"],
];
